...
// Extension function to access minecraft extension
...
// Reobfuscate the shaded jar for production use
extensions.configure<NamedDomainObjectContainer<net.minecraftforge.gradle.userdev.tasks.RenameJarInPlace>>("reobf") {
    create("shadowJar")
}

// Make build task depend on the reobfuscated shadow jar
tasks.named("build") {
