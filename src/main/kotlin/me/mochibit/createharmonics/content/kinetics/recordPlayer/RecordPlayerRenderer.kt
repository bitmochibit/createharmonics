...
import com.simibubi.create.content.kinetics.base.KineticBlockEntityRenderer.getAngleForBe
...
class RecordPlayerRenderer(
    ...
    override fun renderSafe(
        ...
        if (be.playerBehaviour.hasRecord()) {
            ...
            val time = AnimationTickHolder.getRenderTime(currentLevel)
            val currentSpeed = be.speed * 0.005f
            val angle = time * currentSpeed % 360f
