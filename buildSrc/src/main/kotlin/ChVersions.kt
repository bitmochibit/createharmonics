...
class ChVersions(
    ...
    val neoForge get() = root.property("neo_version").toString()
    ...
    val kotlinForNeoForge get() = root.property("kotlin_for_neoforge_version").toString()
    ...
    val sable get() = root.property("sable_version").toString()
