...
val architecturyApiVersion = property("architectury_api_version") as String
        ...
        all {
            ...
            mods {
                create(modId) {
                    ...
                    // Include common module sources so dev-run sees shared code
...
sourceSets {
    main {
        ...
        // Merge common module resources into the Forge build
...
dependencies {
    ...
    // ── Common module ──────────────────────────────────────────────────────────
    // compileOnly so the classes are not duplicated in the output jar;
    // the shadowJar / reobfJar tasks pick up common's compiled output separately.
    ...
    // Architectury API — Forge platform
    implementation(fg.deobf("dev.architectury:architectury-forge:$architecturyApiVersion"))
